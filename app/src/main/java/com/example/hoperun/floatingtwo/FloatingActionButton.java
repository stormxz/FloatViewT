...
/**
 * author：stormXZ on 17-8-29 14:38
 */
public class FloatingActionButton extends ImageButton {
  ...
  public static final boolean displayTitle = true;
   ...
   * @param context
   * @param attributeSet
   * add a styleable for developer to design diff
   * we can see file styles.xml
   */
  ...
  /**
   *  update drawable size for onMeasure method
   */
  ...
  */
  ...
  /**
   *  update background by LayerDrawable
   */
  void updateBackground() {
    ...
    LayerDrawable layerDrawable = new LayerDrawable(
        new Drawable[] {
            getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.transparent_drawable : R.drawable.transparent_drawable),
  ...
  /**
   * @param drawable
   *  set new background for imagebutton
   */
